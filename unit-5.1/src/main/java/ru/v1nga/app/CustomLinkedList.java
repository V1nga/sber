 ...
 * односвязного списка, хранящего произвольные объекты {@code Object}.
 */
public class CustomLinkedList {
    ...
    public void remove(Object object) {
        ...
        if (Objects.equals(object, headNode.currentNode)) {
        ...
        while (current.nextNode != null) {
            if (Objects.equals(object, current.nextNode.currentNode)) {
